      ...
      <div className="hero h-[120vh] min-h-fit bg-slate-700 lg:h-[85svh]">
        <div className="hero-content flex-col text-neutral-content lg:flex-row">
          ...
          <div className="lg:w-[60vw]">
            ...
            <p className="py-6">
              Track your Progress and Set New Personal Records with Ease! Our app&apos;s PR Tracker feature allows you
              to easily view your best lifts for specific sets, along with your current 1RM. Plus, our built-in
              calculator gives you a theoretical 1RM based on the set weight you enter, making it easier than ever to
              track your progress and see your gains in real-time. Try it now and take your lifting game to the next
              level!
            </p>
          </div>
        </div>
