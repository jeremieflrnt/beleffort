...
CREATE TABLE "User" (
    ...
    "image" TEXT,
    "isKg" BOOLEAN NOT NULL DEFAULT true,
...
-- AddForeignKey
ALTER TABLE "Lift" ADD CONSTRAINT "Lift_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
